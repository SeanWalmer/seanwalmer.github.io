    ...
    <header>
        ...
        <div className="container">
            ...
            <ul className="right hide-on-med-and-down">
                ...
                <li><a href="https://www.linkedin.com/in/seanwalmer/" className="tooltipped btn-floating btn-small deep-purple accent-4" data-position="bottom" data-tooltip="LinkedIn" target="_blank" rel="noopener noreferrer"> <i class="fab fa-linkedin"></i></a></li>
                <li><a href="https://github.com/SeanWalmer" className="tooltipped btn-floating btn-small deep-purple accent-4" data-position="bottom" data-tooltip="GitHub" target="_blank" rel="noopener noreferrer"><i class="fab fa-github"></i></a></li>
                <li><a href="https://www.instagram.com/darwful_sean/" className="tooltipped btn-floating btn-small deep-purple accent-4" data-position="bottom" data-tooltip="Instagram" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram"></i></a></li>
            </ul>
